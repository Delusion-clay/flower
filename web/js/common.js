$(function() {
		$(".currencyBox").hover(function() {
			...
			$(".currency_detial").delay(300).slideDown(500, "easeOutBounce");//弹跳减速
			},  
			function() {
			$(".currency_detial").delay(300).fadeOut(100, "easeInCubic");
		});
		$(".cart-block").hover(function() {
			$(this).addClass('active');
			$("#minicart").delay(300).slideDown(500, "easeOutBounce");
			},  
			function() {
			$("#minicart").delay(300).fadeOut(100, "easeInCubic");
		});
});
